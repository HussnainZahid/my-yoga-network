        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-5">
              ...
              <h5 className="ds-5 my-3">
                A Path to <br className="d-none d-md-inline" />
                Holistic Wellness
              </h5>
              <p className="fs-5 text-500 mb-8">
                To lead as the premier network delivering customized yoga
                programs for hotels, corporates, schools, and healthcare,
                promoting a healthier, more balanced global community.
              </p>
            ...
            <div className="col-lg-6 offset-lg-1 mt-lg-0 mt-8">
              <p className="fs-5 text-900 mb-5">
                <span className="fw-bold">My Yoga Network</span> was founded in
                2012 with a passion for wellness, aiming to bring accessible
                yoga to organizations globally. From modest beginnings, we’ve
                evolved into a trusted network, connecting certified instructors
                with hotels, corporates, schools, and healthcare providers. Over
                the years,{" "}
                <span className="fw-bold">
                  we’ve delivered tailored yoga sessions
                </span>
                , reflecting our expertise and holistic approach. Our journey is
                marked by{" "}
                <span className="fw-bold">
                  steady growth, strong partnerships, and a dedication to
                  well-being
                </span>{" "}
                , with a proud legacy of positive impact.
              </p>
              <p className="fs-5 text-900 mb-5">
                Thank you for choosing{" "}
                <span className="fw-bold">My Yoga Network</span> as your wellness
                partner. We’re excited to support your{" "}
                <span className="fw-bold">
                  health goals and promote balance
                </span>{" "}
              ...
              <div className="swiper-wrapper">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="bg-neutral-100 card-testimonial-3 p-5 rounded-3 position-relative">
                    ...
                    <p className="text-900 border-bottom pb-4 mb-4">
                      The dedication of our My Yoga Network team has
                      transformed our wellness journey.{" "}
                      <span className="fw-bold">
