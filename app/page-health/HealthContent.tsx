                ...
                <div className="col-lg-6">
                  <div className="backdrop-filter p-8 position-relative rounded-3">
                    ...
                    <p className="fs-5 text-900">
                      Customized yoga programs to enhance patient recovery,
                      reduce stress, and boost well-being in healthcare
                      facilities.
                    </p>
                    ...
                    <div className="row align-items-center rounded-3 bg-white p-5">
                      ...
                      <div className="col-lg-7">
                        <div className="p-lg-3">
                          ...
                          <p>
                            In healthcare, patient recovery and well-being are
                            the top priorities. At My Yoga Network, we offer
                            yoga programs specifically designed for patients,
                            helping to enhance recovery, reduce stress, manage
                            pain, and improve overall mental and emotional
                            well-being. Our holistic approach is grounded in
                            therapeutic yoga practices that support the healing
                            process and improve quality of life for patients.
                          </p>
                    ...
                    <div className="row align-items-center rounded-3 bg-white p-5">
                      ...
                      <div className="col-lg-7">
                        <div className="p-lg-3">
                          ...
                          <p>
                            We specialize in creating customized yoga sessions
                            for specific health concerns, such as chronic pain,
                            anxiety and depression, post-trauma recovery
                            (including PTSD), musculoskeletal disorders, and
                            sleep issues. Yoga can complement traditional
                            treatments, offering holistic support to manage
                            symptoms and promote long-term wellness.
                          </p>
                          <div className="d-flex pt-5">
                            <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                              <div className="icon">
                        ...
                        <div className="p-lg-3">
                          ...
                          <div className="d-flex">
                            ...
                            <div className="ps-5">
                              ...
                              <p>
                                Controlled breathing exercises <br /> improve
                                lung function and vitality.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="col-lg-7">
                        <div className="p-lg-3">
                          ...
                          <p>
                            ...
                            stress, and improving physical function through
                            yoga.
                          </p>
                          <div className="d-flex pt-5">
                            <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                            ...
                            <div className="ps-5">
                              <h6>Group Healing</h6>
                              <p>
                                Supports recovery with <br /> community
                                sessions.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="p-lg-3">
                          ...
                          <div className="d-flex pt-5">
                            ...
                            <div className="ps-5">
                              ...
                              <p>
                                Promotes relaxation with <br /> morning
                                sessions.
                              </p>
                            </div>
                          </div>
                    ...
                    <div className="row align-items-center rounded-3 bg-white p-5">
                      ...
                      <div className="col-lg-7">
                        <div className="p-lg-3">
                          ...
                          <p>
                            Our community yoga programs build connections,
                            promote health, and offer inclusive wellness
                            sessions led by experienced instructors for all
                            ages.
                          </p>
                          <div className="d-flex pt-5">
                            <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                          ...
                          <div className="d-flex">
                            ...
                            <div className="ps-5">
                              ...
                              <p>
                                Welcomes everyone with <br /> adaptable
                                practices.
                              </p>
                            </div>
                          </div>
              ...
              <div className="col-lg-3 col-md-6">
                ...
                >
                  ...
                  <p>
                    ...
                    trial. Explore tailored sessions, expert-led practices, and
                    a preview of long-term wellness <br /> benefits in a
                    risk-free setting.
                  </p>
                  <Link href="#" className="text-primary fs-7 fw-bold">
                    Learn More
                ...
                <div className="p-2 rounded-4 shadow-1 bg-white position-relative z-1 hover-up mb-4">
                  <div className="card-service bg-white p-6 border rounded-4 text-center">
                    ...
                    <p className="mb-6">
                      ...
                      enhancing strength, flexibility, and mobility, delivering
                      a comprehensive approach to patient recovery.
                    </p>
                    <Link href="#" className="text-primary fs-7 fw-bold">
                      Learn More
                      <svg
              ...
              <div className="col-lg-4 col-md-6">
                <div className="p-2 rounded-4 shadow-1 bg-white position-relative z-1 hover-up mb-4">
                  <div className="card-service bg-white p-6 border rounded-4 text-center">
                    ...
                    <p className="mb-6">
                      Yoga effectively mitigates symptoms of anxiety,
                      depression, and stress, empowering patients to address the
                      emotional dimensions of their recovery journey with
                      greater resilience.
                    </p>
                    <Link href="#" className="text-primary fs-7 fw-bold">
                      Learn More
                ...
                <div className="p-2 rounded-4 shadow-1 bg-white position-relative z-1 hover-up mb-4">
                  <div className="card-service bg-white p-6 border rounded-4 text-center">
                    ...
                    <p className="mb-6">
                      ...
                      critical factor in supporting patients' overall healing
            ...
            <div className="container">
              <div className="row align-items-center">
                <div className="col-lg-5">
                  ...
                  <p>
                    We strive to build long-lasting partnerships with our
                    clients, understanding their unique challenges and
                    opportunities, and providing tailored strategies that lead
