          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="pe-lg-8 me-lg-auto mb-5 mb-lg-0">
                ...
                <p className="fs-5">
                  Book a consultation, ask a question, or get in touch with us
                  to design a custom yoga and wellness program for your
                  business. For career opportunities as a certified yoga
                  instructor at My Yoga Network, please visit our website.
                </p>
              </div>
            </div>
            <div className="col-lg-6">
              ...
              <div className="h-100 bg-primary rounded-4 d-flex align-items-center justify-content-center border position-relative border-5 fix border-white py-5">
                <div className="position-relative z-1 fix">
                  <div className="d-flex justify-content-center">
                    <img src="/assets/imgs/hero-1/avatar-1.png" alt="Avatar 1" />
                    <img
                      className="avt-hero"
                    ...
                    <img
                      className="avt-hero"
                      src="/assets/imgs/hero-1/avatar-3.png" // Removed leading space
                      alt="Avatar 3"
                    />
                  </div>
          ...
          <div className="row">
            <div className="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
              <div className="feature-item mb-5 mb-lg-0 pe-5 hover-up">
                ...
                <p className="text-500">
                  Email <span className="text-900">team@myyoganetwork.com</span>{" "}
                  for assistance with our customized yoga and wellness programs
                  for hotels, corporates, schools, and healthcare providers, or
                  refer to our FAQs and resources.
                </p>
              </div>
            </div>
            <div className="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
              <div className="feature-item mb-5 mb-lg-0 pe-5 hover-up">
                ...
                <h6>Call Us</h6>
                <p className="text-500">
                  Call us to speak with a member of our team about your yoga and
                  wellness program needs for hotels, corporates, schools, or
            ...
            <div className="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
              <div className="feature-item mb-5 mb-lg-0 pe-5 hover-up">
                ...
                <p className="text-500">
                  Contact our sales department for collaboration or partnership
                  inquiries related to customized yoga and wellness programs for
                  hotels, corporates, schools, or healthcare providers. <br />
                  +1 888-960-9240
                </p>
              </div>
            </div>
            <div className="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
              <div className="feature-item mb-5 mb-lg-0 pe-5 hover-up">
                ...
                <h6>Global Branch</h6>
                <p className="text-500">
                  Contact us to explore opportunities for expanding our
                  customized yoga and wellness programs to new global locations.
                  <br />
                  +1 888-960-9240
                </p>
              </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="d-flex align-items-center justify-content-center bg-primary-soft-keep border border-2 border-white-keep d-inline-flex rounded-pill px-4 py-2">
                <img src="/assets/imgs/features-1/dots.png" alt="Decoration" />
                <span className="tag-spacing fs-7 fw-bold text-linear-2 ms-2 text-uppercase">
                  Contact Us
                </span>
              </div>
              <h5 className="ds-5 mt-3 mb-3 text-white">
                Considering a yoga program? Contact us.
              </h5>
              <span className="fs-5 fw-medium text-white">
                Let us know if you have a question, wish to comment, or need
                more information about <br className="d-none d-lg-block" />
                My Yoga Network
              </span>
              <div className="d-flex pt-6 pb-3 align-items-center">
                ...
                <div className="ps-5">
                  ...
                  <p className="text-white mb-0">
                    Explore articles and guides on our yoga and wellness
                    <br />
              ...
              <div className="d-flex pt-3 pb-3 align-items-center">
                ...
                <div className="ps-5">
                  <h6 className="text-white">Watch Yoga Tutorials</h6>
                  <p className="text-white mb-0">
                    View our video guides for visual walkthroughs of <br />
                    our yoga and wellness sessions.
                  </p>
                </div>
              </div>
              <div className="d-flex pt-3 pb-3 align-items-center">
                ...
                <div className="ps-5">
                  <h6 className="text-white">Visit the Knowledge Base</h6>
                  <p className="text-white mb-0">
                    Learn how we can enhance your business with <br />
              ...
              <div className="position-relative">
                <div className="position-relative z-2 p-3 p-md-5 p-lg-8 rounded-3 bg-primary">
                  ...
                  <p className="text-white">
                    Interested in learning more or contacting our sales team for
                    yoga and wellness programs?
                  </p>
                  <form action="/api/contact" method="POST"> {/* Example action */}
