            ...
            <div className="row mask-image">
              <div className="text-center mb-7">
                ...
                <p className="fs-5 text-900 mb-0">
                  Partnering with leading educational and community
              ...
              <div className="col-lg-6 px-lg-6 mt-lg-0 mt-8">
                ...
                >
                  ...
                  <div className="content mt-md-0 mt-4 ms-5">
                    ...
                    <p>
                      Ensures safety with TB clearance, fingerprinting,
                      qualified staff, insurance, CPR/First Aid, and training.
                    </p>
                  </div>
                </Link>
              </div>
              ...
              <div className="col-lg-6 pe-lg-8">
                ...
                >
                  ...
                  <span className="content ms-5 mt-md-0 mt-3">
                    ...
                    <p>
                      Creative expression combined with mindfulness techniques
                      to foster emotional release and self-discovery.
                    </p>
                  </span>
                </Link>
                <Link
                ...
                >
                  ...
                  <span className="content ms-5 mt-md-0 mt-3">
                    ...
                    <p>
                      Activities designed to foster collaboration,
          ...
          <div className="container position-relative z-2">
            <div className="text-center">
              ...
              <p className="fs-5 text-900 mb-0">
                ...
                design engaging, age-appropriate wellness experiences. Explore
                our flexible pairings:
              </p>
            </div>
                ...
                <div className="p-2 rounded-4 shadow-1 bg-white position-relative z-1 hover-up mb-4">
                  <div className="card-service bg-white p-6 border rounded-4 text-center">
                    ...
                    <ul className="mb-6 text-start">
                      ...
                      <li>
                        1 hr rhythm & sound (e.g., drumming circles, sound
                        baths, sing-alongs)
                      </li>
                    </ul>
                    <p className="mb-6">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="p-2 rounded-4 shadow-1 bg-white position-relative z-1 hover-up mb-4">
                  <div className="card-service bg-white p-6 border rounded-4 text-center">
                    ...
                    <h5 className="my-3">
                      Yoga + Healthy Cooking or Nutrition
                    </h5>
                    <ul className="mb-6 text-start">
                      <li>45 min yoga with digestive breathwork</li>
                      <li>
                        1 hr food-based fun (fruit kabobs, smoothie demos,
                        mindful eating lessons)
                      </li>
                    </ul>
                    <p className="mb-6">
                      Why it works:
                      <br /> Matches ELO-P interest areas like cooking and
                      healthy choices. Kids love it!
                    </p>
                    <Link href="#" className="text-primary fs-7 fw-bold">
                      <svg
                        className=" ms-2 "
                ...
                <div className="p-2 rounded-4 shadow-1 bg-white position-relative z-1 hover-up mb-4">
                  <div className="card-service bg-white p-6 border rounded-4 text-center">
                    ...
                    <p className="mb-6">
                      Why it works:
                      <br />
                      Promotes rest, recovery, and imagination. Ideal for
                      younger students.
                    </p>
                    <Link href="#" className="text-primary fs-7 fw-bold">
                      <svg
