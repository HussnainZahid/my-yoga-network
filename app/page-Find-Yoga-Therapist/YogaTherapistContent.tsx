        ...
        <div className="container position-relative z-1">
          <div className="text-start">
            ...
            <div className="d-flex">
              ...
              <p className="text-primary mb-0">Find Yoga Therapist</p>
            </div>
          </div>
        </div>
        <img
      ...
      <section className="section-feature-12 border-bottom pb-120 pt-110">
        <div className="container">
          <div className="text-center">
            <h5 className="ds-5">Contact Us</h5>
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="feature-item mb-5 bg-neutral-100 p-7 rounded-4 hover-up shadow-sm">
                ...
                <h4 className="text-primary">Get Connected</h4>
                <form id="contactForm" className="needs-validation" noValidate>
                  ...
                  <div className="mb-4">
                    <label
                      htmlFor="message"
                      className="form-label fs-6 text-900"
                    >
                      Describe your condition or upload a video message
                      (optional)
                    </label>
                    <textarea
                      ...
                      id="message"
                      rows={3}
                      placeholder="Describe your needs or leave blank to upload a video"
                    ></textarea>
                    <input
                      type="file"
                      className="form-control rounded-3"
                    ...
                    <div className="form-text text-muted">
                      Max file size: 50MB. Supported formats: MP4, AVI.
                    </div>
                  </div>
                  <button
                    type="submit"
