          ...
          <div className="container">
            <div className="text-center">
              ...
              <p className="fs-5 mb-0">
                Welcome to My Yoga Network. These Terms and Conditions ("Terms")
                govern your use of our website,{" "}
                <br className="d-none d-lg-block" />
                platform, and services (collectively, "Services"). By accessing
                or using our Services, you agree to be{" "}
                <br className="d-none d-lg-block" />
            ...
            <div className="row pt-110">
              <div className="col-lg-8 col-md-10 mx-md-auto">
                ...
                <ul>
                  ...
                  <li>
                    Violate any laws, rules, or regulations in connection with
                  ...
                  <li>
                    Engage in any activity that could harm or damage our
                ...
                <p>
                  ...
                  and software, are the property of My Yoga Network or our
                ...
                <p>
                  ...
                  and commercial purposes in accordance with these Terms. You
                  may not:
                </p>
                <ul>
                  <li>
                ...
                <p>
                  By submitting any content to our Services, you grant us a
                  ...
                  works of, display, and perform the content in connection with
                ...
                <p>
                  ...
                  consequences of sharing it. You represent and warrant that you
                  have all necessary rights to submit the content and that it
                  does not infringe or violate any third-party rights or any
                  laws.
                </p>
                <h4 className="text-primary mt-4">Payment and Billing</h4>
                <h5 className="my-3">Fees</h5>
                <p>
                  Certain features of our Services may be subject to fees. You
                  agree to pay all applicable fees in connection with your use
                  of our Services. We reserve the right to change our fees at
                  any time, with notice to you if required by applicable law.
                </p>
                <h5 className="my-3">Billing</h5>
                <p>
                  You authorize us to charge your designated payment method for
                  the fees due. If we are unable to process your payment, we may
                  suspend or terminate your access to the Services.
                </p>
                <p>
                  If you have any questions or concerns about this Terms and
                ...
                <p>
                  ...
                  if you breach these Terms. Upon termination, your right to use
                ...
                <p>
                  To the maximum extent permitted by law, My Yoga Network and
                ...
                <p>
                  You agree to defend, indemnify, and hold harmless My Yoga
                  Network and its affiliates, officers, directors, employees,
                ...
                <p>
                  ...
                  personal jurisdiction of the courts located in [Your
                  Jurisdiction] for the purpose of litigating all such claims or
                  disputes.
                </p>
                ...
                <p>
                  ...
                  taking effect. Your continued use of the Services after any
                ...
                <div className="row">
                  <div className="col">
                    ...
                    <p className="text-500">
                      Speak with our team about your yoga and wellness program
                      needs.
                    </p>
        ...
        <section className="section-testimonial-3 position-relative section-padding fix">
          <div className="container position-relative z-1">
              ...
              <div className="col-lg-7 mx-lg-auto">
                <div className="text-center mb-lg-0 mb-5">
                  ...
                  <p className="fs-5 mb-0 text-900">
                    Experience transformative feedback on our tailored yoga
                    programs and exclusive <br className="d-none d-md-block" />
            ...
            <div className="bg-neutral-100 card-testimonial-3 p-5 rounded-3 position-relative">
              ...
              <p className="text-900 border-bottom pb-4 mb-4">The dedication of My Yoga Network has transformed our guest experience. <span className="fw-bold">Their tailored yoga programs and expert support</span> have boosted satisfaction and relaxation, streamlining our wellness offerings.</p>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width={52} height={52} viewBox="0 0 52 52" fill="none">
                      ...
                      <div className="d-flex align-items-center mb-5">
                        ...
                        <div className="d-flex flex-column">
                          ...
                          <div className="flag ms-3">
                            ...
                            />
                            <span className="fs-8">
                              HR Manager, Horizon Corp
                            </span>
                          </div>
                        </div>
                      </div>
                      <p className="text-900 border-bottom pb-4 mb-4">
                        My Yoga Network’s expertise has revolutionized our
                        employee wellness.{" "}
                        <span className="fw-bold">
                          Their customized programs and supportive team
                        </span>{" "}
                        have enhanced productivity and reduced stress
                        effectively.
                      </p>
                      <div className="d-flex">
                        <img
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="bg-neutral-100 card-testimonial-3 p-5 rounded-3 position-relative">
                      ...
                      <p className="text-900 border-bottom pb-4 mb-4">
                        My Yoga Network has enriched our school’s wellness
                        culture.{" "}
                        <span className="fw-bold">
                          Their tailored Kids Yoga programs and dedicated
                          instructors
                        </span>{" "}
                        have improved focus and resilience among students.
                      </p>
                      <div className="d-flex">
                        <img
                          src="/assets/imgs/hero-4/star-yellow.svg"
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="bg-neutral-100 card-testimonial-3 p-5 rounded-3 position-relative">
                      ...
                      <p className="text-900 border-bottom pb-4 mb-4">
                        My Yoga Network’s team has elevated our patient care.{" "}
                        <span className="fw-bold">
                          Their therapeutic programs and expert guidance
                        </span>{" "}
                        have supported recovery and staff well-being
                        effectively.
                      </p>
                      <div className="d-flex">
                        <img
